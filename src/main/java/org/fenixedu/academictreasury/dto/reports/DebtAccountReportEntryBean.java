...
public class DebtAccountReportEntryBean implements SpreadsheetRow {
    ...
    public DebtAccountReportEntryBean(final DebtAccount debtAccount, final ErrorsLog errorsLog) {
        ...
        try {
            ...
            if (debtAccount.getCustomer().isPersonCustomer() && ((PersonCustomer) debtAccount.getCustomer()).getPerson().getIdDocumentType() != null) {
                this.identificationType = ((PersonCustomer) debtAccount.getCustomer()).getPerson().getIdDocumentType().getLocalizedNameI18N();
            }
            ...
            if (debtAccount.getCustomer().isPersonCustomer() && ((PersonCustomer) debtAccount.getCustomer()).getPerson().getStudent() != null) {
