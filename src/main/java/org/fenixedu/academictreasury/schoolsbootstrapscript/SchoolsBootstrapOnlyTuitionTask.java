...
//            return oldCode;
        ...
        private void createTuitionForRegistrationTariffs_FF_FROM_SPREADSHEET() {
          ...
          //FF    ESTUDANTE INTERNACIONAL, 1º ANO 1º VEZ, PARCIAL ESTUDANTE INTERNACIONAL, 1º ANO 1º VEZ, PARCIAL   101 $D$7                                                                                                                
            ...
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/10/2015")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_1_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("600.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/01/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_2_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("459.25")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                               
            ...
            if (!fromAcronymsToFinantialInstitutionList("FF").isEmpty()) { TuitionPaymentPlanBean tuitionPaymentPlanBean = new TuitionPaymentPlanBean(TuitionPaymentPlanGroup.findUniqueDefaultGroupForRegistration().get().getCurrentProduct(), TuitionPaymentPlanGroup.findUniqueDefaultGroupForRegistration().get(), oneOfFinantialEntity("FF"), defaultExecutionYear()); tuitionPaymentPlanBean.setDegreeCurricularPlans(readDegreeCurricularPlans("", "M. Control. Q.T.A, M. Quim. Farm. Terap.", "")); tuitionPaymentPlanBean.setDefaultPaymentPlan(false); tuitionPaymentPlanBean.setRegistrationRegimeType(registrationRegimeType("")); tuitionPaymentPlanBean.setRegistrationProtocol(registrationProtocol("")); tuitionPaymentPlanBean.setIngression(ingression("ESTUDANTE_INTERNACIONAL")); tuitionPaymentPlanBean.setCurricularYear(curricularYear("")); tuitionPaymentPlanBean.setStatuteType(statuteType("")); tuitionPaymentPlanBean.setCustomized(false); tuitionPaymentPlanBean.setName(""); tuitionPaymentPlanBean.setFirstTimeStudent(true);                                                                                                                               
                                                                                                                                            
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/10/2015")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_1_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("500")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/01/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_2_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("687.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/03/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_3_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("687.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/05/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_4_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("687.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/06/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_5_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("687.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            TuitionPaymentPlan.create(tuitionPaymentPlanBean); }                                                                                                                                
            ...
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/10/2015")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_1_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("750")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/01/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_2_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("750")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/04/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_3_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("750")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/07/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_4_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("750")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/09/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_5_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("750")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            ...
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/10/2015")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_1_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("500")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/01/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_2_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("250")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/03/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_3_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("250")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/05/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_4_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("250")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/06/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_5_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("250")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            TuitionPaymentPlan.create(tuitionPaymentPlanBean); }                                                                                                                                
            ...
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/01/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_2_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("168.75")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                               
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/03/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_3_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("168.75")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                               
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/05/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_4_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("168.75")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                               
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/06/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_5_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("168.75")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                               
            TuitionPaymentPlan.create(tuitionPaymentPlanBean); }                                                                                                                                
            ...
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/10/2015")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_1_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("227.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/01/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_2_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("227.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/04/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_3_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("227.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/07/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_4_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("227.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/09/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_5_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("227.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            ...
            if (!fromAcronymsToFinantialInstitutionList("FF").isEmpty()) { TuitionPaymentPlanBean tuitionPaymentPlanBean = new TuitionPaymentPlanBean(TuitionPaymentPlanGroup.findUniqueDefaultGroupForRegistration().get().getCurrentProduct(), TuitionPaymentPlanGroup.findUniqueDefaultGroupForRegistration().get(), oneOfFinantialEntity("FF"), defaultExecutionYear()); tuitionPaymentPlanBean.setDegreeCurricularPlans(readDegreeCurricularPlans("", "M. Control. Q.T.A, M. Quim. Farm. Terap.", "")); tuitionPaymentPlanBean.setDefaultPaymentPlan(true); tuitionPaymentPlanBean.setRegistrationRegimeType(registrationRegimeType("")); tuitionPaymentPlanBean.setRegistrationProtocol(registrationProtocol("")); tuitionPaymentPlanBean.setIngression(ingression("")); tuitionPaymentPlanBean.setCurricularYear(curricularYear("")); tuitionPaymentPlanBean.setStatuteType(statuteType("")); tuitionPaymentPlanBean.setCustomized(false); tuitionPaymentPlanBean.setName(""); tuitionPaymentPlanBean.setFirstTimeStudent(false);                                                                                                                              
                                                                                                                                            
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/10/2015")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_1_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("350")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/01/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_2_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("350")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/04/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_3_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("350")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/07/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_4_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("350")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/09/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_5_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("350")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                              
            ...
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/01/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_1_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("145.83")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                               
            ...
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/07/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_7_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("437.5")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                                
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/09/2016")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_8_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.FIXED_AMOUNT); tuitionPaymentPlanBean.setFixedAmount(amount("437.52")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                               
            TuitionPaymentPlan.create(tuitionPaymentPlanBean); }                                                                                                                                
            ...
            tuitionPaymentPlanBean.setBeginDate(defaultExecutionYear().getBeginLocalDate()); tuitionPaymentPlanBean.setEndDate(null); tuitionPaymentPlanBean.setDueDateCalculationType(DueDateCalculationType.BEST_OF_FIXED_DATE_AND_DAYS_AFTER_CREATION); tuitionPaymentPlanBean.setFixedDueDate(fixedDueDate("20/10/2015")); tuitionPaymentPlanBean.setNumberOfDaysAfterCreationForDueDate(0); tuitionPaymentPlanBean.setApplyInterests(true); if(tuitionPaymentPlanBean.isApplyInterests()) { tuitionPaymentPlanBean.setInterestType(InterestType.GLOBAL_RATE); } tuitionPaymentPlanBean.setApplyInFirstWorkday(true); tuitionPaymentPlanBean.setTuitionInstallmentProduct(Product.findUniqueByCode(translateProductCode("PROPINA_1_PRESTACAO_2_CICLO")).get()); tuitionPaymentPlanBean.setTuitionCalculationType(TuitionCalculationType.ECTS); tuitionPaymentPlanBean.setFixedAmount(amount("25")); tuitionPaymentPlanBean.setEctsCalculationType(ectsCalculationType("FIXED_AMOUNT")); tuitionPaymentPlanBean.setFactor(amount("")); tuitionPaymentPlanBean.setTotalEctsOrUnits(amount("")); tuitionPaymentPlanBean.setAcademicalActBlockingOn(true); tuitionPaymentPlanBean.addInstallment();                                                                                                                               
            TuitionPaymentPlan.create(tuitionPaymentPlanBean); }  
