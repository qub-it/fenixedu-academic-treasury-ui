...
<div class="page-header">
	<h1>
		<spring:message code="label.ExemptionsGenerationRequestFile.create" />
		<small></small>
	</h1>
</div>
...
<form name='form' method="post" class="form-horizontal" 
	action='${pageContext.request.contextPath}<%= ExemptionsGenerationRequestFileController.CREATE_URL %>' enctype="multipart/form-data">
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<select id="treasuryExemptionTypeId" name="treasuryExemptionTypeId">
						<option value="-1">&nbsp;</option>
						<c:forEach items="${treasuryExemptionTypesSet}" var="t">
			...
			<script>
				$(document).ready(function() {
					$("#treasuryExemptionTypeId").select2().select2('val', '${param.treasuryExemptionTypeId != null ? param.treasuryExemptionTypeId : null}');
				});
			</script>

			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.ExemptionsGenerationRequestFile.requestFile" />
				</div>
