		...
		<div class="panel-body">
			...
			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.AcademicServiceRequestDebtCreationBean.registration" />
				</div>

				<div class="col-sm-6">
					<%-- Relation to side 1 drop down rendered in input --%>
					<ui-select id="academicServiceRequestDebtCreationBean_registration"
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<%-- Relation to side 1 drop down rendered in input --%>
					<ui-select id="academicServiceRequestDebtCreationBean_academicServiceRequest"
						name="registration" ng-model="$parent.object.academicServiceRequest"
						theme="bootstrap" ng-disabled="disabled"
						on-select="onBeanChange($model)"> <ui-select-match>{{$select.selected.text}}</ui-select-match>
					<ui-select-choices
					...
					<span ng-bind-html="academicServiceRequest.text | highlight: $select.search"></span>
					</ui-select-choices> </ui-select>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.AcademicServiceRequestDebtCreationBean.debtDate" />
				</div>

				<div class="col-sm-6">
					<input id="academicServiceRequestDebtCreationBean_debtDate" class="form-control"
