...
<%@page import="org.fenixedu.academictreasury.domain.emoluments.AcademicTax"%>
...
<div class="page-header">
	<h1>
		<spring:message code="label.manageAcademicTax.createAcademicTax" />
		<small></small>
	</h1>
</div>
		...
		<div class="panel-body">
			<div class="form-group row">
				<div class="col-sm-2 control-label">
					<spring:message code="label.AcademicTax.product" />
				</div>
