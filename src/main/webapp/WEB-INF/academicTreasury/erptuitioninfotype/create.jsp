...
<div ng-app="angularApp" ng-controller="Controller">
	...
	<div class="panel panel-default">
		...
		<form id="payment-plan-group-form" name='form' method="post" class="form-horizontal">
			...
			<input id="payment-plan-group-postback" type="hidden" name="postback"
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					...
					<ui-select id="erpTuitionInfoType_tuitionPaymentPlanGroup" name="tuitionPaymentPlanGroup" 
						ng-model="$parent.object.tuitionPaymentPlanGroup" theme="bootstrap" ng-disabled="disabled" on-select="onTuitionPaymentPlanGroupChange($model)">
						<ui-select-match>{{$select.selected.text}}</ui-select-match>
						<ui-select-choices repeat="group.id as group in object.tuitionPaymentPlanGroupDataSource | filter: $select.search">
