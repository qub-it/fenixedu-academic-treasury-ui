...
<div class="well well-sm" style="display:inline-block">
	...
	&nbsp;
	<a class="" href="${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.CHOOSEDEGREECURRICULARPLAN_URL %>/${finantialEntity.externalId}/${executionYear.externalId}">
...
<c:forEach items="${searchtuitionpaymentplanResultsDataSet}" var="paymentPlan"  varStatus="loopStatus">
	...
	<p>
		<a href="${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.SEARCH_TO_DELETE_ACTION_URL %>/${finantialEntity.externalId}/${executionYear.externalId}/${degreeCurricularPlan.externalId}/${paymentPlan.externalId}">
			<spring:message code="label.TuitionPaymentPlan.delete.plan" />
		</a>
		&nbsp;
		<a href="${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.ORDER_UP_ACTION_URL %>/${finantialEntity.externalId}/${executionYear.externalId}/${degreeCurricularPlan.externalId}/${paymentPlan.externalId}">
			<spring:message code="label.TuitionPaymentPlan.order.up" />
		</a>
		&nbsp;
		<a href="${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.ORDER_DOWN_ACTION_URL %>/${finantialEntity.externalId}/${executionYear.externalId}/${degreeCurricularPlan.externalId}/${paymentPlan.externalId}">
