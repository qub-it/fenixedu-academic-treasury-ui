...
<form id="form" name='form' method="post" class="form-horizontal"
	...
	action='${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.CREATEDEFINESTUDENTCONDITIONS_URL %>/${finantialEntity.externalId}/${executionYear.externalId}'>
	
	
	<input id="cancelUrl" type="hidden" name="cancelUrl" 
		value='${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.CHOOSEDEGREECURRICULARPLAN_URL %>/${finantialEntity.externalId}/${executionYear.externalId}' />
	
	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.CREATECHOOSEDEGREECURRICULARPLANSPOSTBACK_URL %>/${finantialEntity.externalId}/${executionYear.externalId}' />
