...
<div class="page-header">
	<h1><spring:message code="label.manageTuitionPaymentPlan.chooseDegreeCurricularPlan" />
		<small></small>
	</h1>
</div>

<%-- Choose Execution Year --%>
<div ng-app="changeExample" ng-controller="ExampleController" style="margin-bottom: 20px" class="container">
	<div class="col-sm-12">
...
<div class="well well-sm" style="display:inline-block">
	...
	<a class="" href="${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.CHOOSEFINANTIALENTITY_URL %>">
		<spring:message code="label.event.back"/>
	</a>
	|&nbsp;&nbsp;
	<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
	&nbsp;
	<a class="" href="${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.CREATECHOOSEDEGREECURRICULARPLANS_URL %>/${finantialEntity.externalId}/${executionYear.externalId}">
...
<datatables:table id="choosedegreecurricularplanTable" row="dcp" data="${choosedegreecurricularplanResultsDataSet}" 
	...
	<datatables:column>
		...
		<%  request.setAttribute("tuitionPaymentPlanCount", (Long) TuitionPaymentPlan.find(TuitionPaymentPlanGroup.findUniqueDefaultGroupForExtracurricular().get(), (DegreeCurricularPlan) request.getAttribute("dcp"), 
	...
	<datatables:column>
		<a  href="${pageContext.request.contextPath}<%= TuitionPaymentPlanControllerExtracurricular.SEARCH_URL %>${finantialEntity.externalId}/${executionYear.externalId}/${dcp.externalId}"
