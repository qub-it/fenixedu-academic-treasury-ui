...
"actions" :
" <a  class=\"btn btn-default btn-xs\" href=\"${pageContext.request.contextPath}/academictreasury/tuitionpaymentplanextracurricular/choosedegreecurricularplan/${searchResult.externalId}/${executionYear.externalId}\"><spring:message code='label.manageTuitionPaymentPlan.chooseFinantialEntity.choose'/></a>" +
                "" 
			},
            </c:forEach>
    ];
