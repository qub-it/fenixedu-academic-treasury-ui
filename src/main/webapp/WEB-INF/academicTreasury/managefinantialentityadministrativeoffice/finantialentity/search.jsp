...
<div class="page-header">
	<h1>
		<spring:message
			code="label.manageFinantialEntityAdministrativeOffice.searchFinantialEntity" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
...
<c:choose>
	<c:when test="${not empty searchfinantialentityResultsDataSet}">
...
" <a  class=\"btn btn-default btn-xs\" href=\"${pageContext.request.contextPath}/academicTreasury/managefinantialentityadministrativeoffice/finantialentity/search/view/${searchResult.externalId}\"><spring:message code='label.view'/></a>" +
	...
	$(document).ready(function() {
		...
		var table = $('#searchfinantialentityTable').DataTable({language : {
...
//"dom": '<"col-sm-6"l>rtip', // FilterBox = NO && ExportOptions = NO
		...
		table.columns.adjust().draw();
		  ...
		  $('#searchfinantialentityTable tbody').on( 'click', 'tr', function () {
