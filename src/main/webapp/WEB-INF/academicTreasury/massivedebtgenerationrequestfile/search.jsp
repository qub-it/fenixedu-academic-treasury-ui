...
<div class="page-header">
	<h1>
		<spring:message code="label.MassiveDebtGenerationRequestFile.search" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	...
	&nbsp;
	<a class="" href="${pageContext.request.contextPath}<%= MassiveDebtGenerationRequestFileController.CREATE_URL %>">
		...
		<datatables:table id="simpletable" row="requestFile" data="${requestFiles}" cssClass="table responsive table-bordered table-hover" cdn="false" cellspacing="2">
			...
			<datatables:column cssStyle="width:10%">
				<datatables:columnHead>
					<spring:message code="label.MassiveDebtGenerationRequestFile.versioningCreationDate" />
				</datatables:columnHead>
			...
			<datatables:column cssStyle="width:10%">
				<datatables:columnHead>
					<spring:message code="label.MassiveDebtGenerationRequestFile.whenProcessed" />
				</datatables:columnHead>
