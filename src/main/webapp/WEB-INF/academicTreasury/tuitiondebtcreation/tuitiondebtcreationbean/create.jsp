...
<div class="page-header">
	<h1><spring:message code="label.TuitionDebtCreation.createTuitionDebtCreationBean" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/academictreasury/tuitiondebtcreation/debtaccount/read"  ><spring:message code="label.event.back" /></a>
|&nbsp;&nbsp;</div>
...
<form name='form' method="post" class="form-horizontal"
	...
	action='${pageContext.request.contextPath}/academictreasury/tuitiondebtcreation/tuitiondebtcreationbean/create'>

	<input type="hidden" name="postback"
		value='${pageContext.request.contextPath}academictreasury/tuitiondebtcreation/tuitiondebtcreationbean/createpostback' />
