...
<div class="page-header">
	<h1>
		<spring:message code="label.ImportTreasury.search" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
	...
	&nbsp;
	<a class="" href="${pageContext.request.contextPath}<%= ImportTreasuryController.CREATE_URL %>">
	...
	<c:when test="${not empty requestFiles}">
		...
		<datatables:table id="simpletable" row="requestFile" data="${requestFiles}" cssClass="table responsive table-bordered table-hover" cdn="false" cellspacing="2">
			...
			<datatables:column cssStyle="width:20%">
				...
				<c:out value="${requestFile.treasuryImportType.name}" />
			</datatables:column>
			...
			<datatables:column cssStyle="width:10%">
				...
				<a class="btn btn-default" href="${pageContext.request.contextPath}<%= ImportTreasuryController.VIEW_URL %>/${requestFile.externalId}">
