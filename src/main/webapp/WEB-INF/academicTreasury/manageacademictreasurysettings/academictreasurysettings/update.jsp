...
<div class="page-header">
    <h1>
        <spring:message code="label.manageAcademicTreasurySettings.updateAcademicTreasurySettings" />
        <small></small>
    </h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span> &nbsp; <a class=""
        href="${pageContext.request.contextPath}<%= AcademicTreasurySettingsController.READ_URL %>"><spring:message code="label.event.back" /></a> |&nbsp;&nbsp;
</div>
        ...
        <div class="panel-body">
            <div class="form-group row">
                <div class="col-sm-2 control-label">
                    <spring:message code="label.AcademicTreasurySettings.emolumentsProductGroup" />
                </div>

                <div class="col-sm-4">
                    <%-- Relation to side 1 drop down rendered in input --%>
                    <select id="academicTreasurySettings_emolumentsProductGroup" class="js-example-basic-single" name="emolumentsproductgroup">
                        <option value=""></option>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <%-- Relation to side 1 drop down rendered in input --%>
                    <select id="academicTreasurySettings_tuitionProductGroup" class="js-example-basic-single" name="tuitionproductgroup">
                        <option value=""></option>
                        <%-- empty option remove it if you don't want to have it or give it a label CHANGE_ME --%>
                    </select>
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <%-- Relation to side 1 drop down rendered in input --%>
                    <select id="academicTreasurySettings_improvementAcademicTax" class="js-example-basic-single" name="improvementacademictax">
                        <option value=""></option>
                    </select>
                </div>
            </div>
