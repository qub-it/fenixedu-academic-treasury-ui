        ...
        <form method="post" class="form-horizontal">
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.AcademicTreasurySettings.improvementAcademicTax" /></th>
                        <td><c:out
                                value="${academicTreasurySettings.improvementAcademicTax.product.name.content}" /></td>
                    </tr>
                    <tr>
                        <th scope="row" class="col-xs-3"><spring:message
                                code="label.AcademicTreasurySettings.closeServiceRequestEmolumentsWithDebitNote" /></th>
                        <td><c:if
...
<h2 style="margin-bottom: 50px">
    <spring:message
        code="label.AcademicTreasurySettings.academicalActBlockingProducts" />
</h2>
<div class="col-sm-12">
    <datatables:table id="academicalActBlockingProductsTable" row="p"
        data="${products}"
            ...
            <p>
                ...
                <c:if
                    ...
                    <p class="label label-warning">
                        <spring:message
                            code="label.AcademicTreasurSettings.academicalActBlocking.selected" />
                    </p>
                </c:if>
            </p>
        </datatables:column>
    ...
    <script>
					createDataTables("academicalActBlockingProductsTable",
							true, false, true,
