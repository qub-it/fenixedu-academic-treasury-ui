...
<div class="page-header">
	<h1><spring:message code="label.manageEmoluments.updateEmolumentTariff" />
		<small></small>
	</h1>
</div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/academictreasury/manageemoluments/academictariff/viewemolumenttariff/${academicTariff.externalId}" ><spring:message code="label.event.back" /></a>
|&nbsp;&nbsp;</div>
...
<div class="col-sm-4">
	...
	value = '<c:out value='${not empty param.begindate ? param.begindate : academicTariff.beginDate }'/>' />
</div>
</div>		
<div class="form-group row">
...
<div class="col-sm-4">
	...
	value = '<c:out value='${not empty param.enddate ? param.enddate : academicTariff.endDate }'/>' />
</div>
</div>		
  </div>
