...
<div class="page-header">
	...
	<h1><spring:message code="label.manageEmoluments.updateEmolumentTariff" /></h1>
</div>
...
<form name="form" method="post" class="form-horizontal" ng-app="changeExample" ng-controller="ExampleController" 
	...
	<div class="panel panel-default">
		...
		<c:if test="${academicTariffBean.applyInterests}">
			...
			<c:if test="${academicTariffBean.interestType.monthly || academicTariffBean.interestType.daily}">
				<div class="form-group row">
					<div class="col-sm-2 control-label">
						<spring:message code="label.AcademicTariff.rate" />
					</div>
	
					<div class="col-sm-10">
						<input id="AcademicTariff_rate" class="form-control"
