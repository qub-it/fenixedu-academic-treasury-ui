...
<h2><spring:message code="label.AcademicDebtGenerationRule.rules" /></h2>
	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<select id="academicDebtGenerationRule_aggregateOnDebitNote"
		...
		$("#academicDebtGenerationRule_aggregateOnDebitNote").select2().select2('val', '<c:out value='${not empty param.aggregateondebitnote ? param.aggregateondebitnote : academicDebtGenerationRuleBean.aggregateOnDebitNote }'/>');
			...
			<div class="form-group row" ng-show="object.aggregateOnDebitNote == 'true'">
				<div class="col-sm-2 control-label">
					<spring:message
				...
				<div class="col-sm-2">
					<select id="academicDebtGenerationRule_aggregateAllOrNothing"
						name="aggregateallornothing" class="form-control"
		...
		$("#academicDebtGenerationRule_aggregateAllOrNothing").select2().select2('val', '<c:out value='${not empty param.aggregateallornothing ? param.aggregateallornothing : academicDebtGenerationRuleBean.aggregateAllOrNothing }'/>');
			...
			<div class="form-group row" ng-show="object.aggregateOnDebitNote == 'true'">
				...
				<div class="col-sm-2">
					<select id="academicDebtGenerationRule_closeDebitNote"
		...
		$("#academicDebtGenerationRule_closeDebitNote").select2().select2('val', '<c:out value='${not empty param.closedebitnote ? param.closedebitnote : academicDebtGenerationRuleBean.closeDebitNote }'/>');
			...
			<div class="form-group row" ng-show="object.aggregateOnDebitNote == 'true' && object.closeDebitNote == 'true'">
				<div class="col-sm-2 control-label">
					<spring:message
				...
				<div class="col-sm-2">
					<select id="academicDebtGenerationRule_createPaymentReferenceCode"
						name="createpaymentreferencecode" class="form-control"
