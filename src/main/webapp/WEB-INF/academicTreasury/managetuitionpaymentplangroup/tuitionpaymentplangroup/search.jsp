...
<div class="page-header">
	<h1><spring:message code="label.manageTuitionPaymentPlanGroup.searchTuitionPaymentPlanGroup" />
		<small></small>
	</h1>
</div>
<%-- NAVIGATION --%>
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/academictreasury/managetuitionpaymentplangroup/tuitionpaymentplangroup/create"   ><spring:message code="label.event.create" /></a>
|&nbsp;&nbsp;</div>
...
<script type="text/javascript">
	  function processDelete(externalId) {
	    url = "${pageContext.request.contextPath}/academictreasury/managetuitionpaymentplangroup/tuitionpaymentplangroup/search/delete/" + externalId;
  ...
  <div class="modal-dialog">
    ...
    <form id ="deleteForm" action="#" method="POST">
      ...
      <div class="modal-body">
        <p><spring:message code = "label.manageTuitionPaymentPlanGroup.searchTuitionPaymentPlanGroup.confirmDelete"/></p>
      </div>
...
<c:choose>
	<c:when test="${not empty searchtuitionpaymentplangroupResultsDataSet}">
		<table id="searchtuitionpaymentplangroupTable" class="table responsive table-bordered table-hover">
			<thead>
				<tr>
					<%--!!!  Field names here --%>
					<th><spring:message code="label.TuitionPaymentPlanGroup.code"/></th>
					<th><spring:message code="label.TuitionPaymentPlanGroup.name"/></th>
					<%-- Operations Column --%>
					<th></th>
				</tr>
			</thead>
...
<script>
	var searchtuitionpaymentplangroupDataSet = [
			<c:forEach items="${searchtuitionpaymentplangroupResultsDataSet}" var="searchResult">
...
" <a  class=\"btn btn-xs btn-danger\" href=\"#\" onClick=\"javascript:processDelete('${searchResult.externalId}')\"><span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span>&nbsp;<spring:message code='label.delete'/></a>" +
	...
	$(document).ready(function() {
		...
		var table = $('#searchtuitionpaymentplangroupTable').DataTable({language : {
...
//"dom": '<"col-sm-6"l>rtip', // FilterBox = NO && ExportOptions = NO
		...
		table.columns.adjust().draw();
		  ...
		  $('#searchtuitionpaymentplangroupTable tbody').on( 'click', 'tr', function () {
