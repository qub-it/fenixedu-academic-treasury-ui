...
<div class="page-header">
    <h1>
        <spring:message
            code="label.manageTuitionPaymentPlanGroup.searchTuitionPaymentPlanGroup" />
        <small></small>
    </h1>
</div>
<%-- NAVIGATION --%>
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}/academictreasury/managetuitionpaymentplangroup/tuitionpaymentplangroup/create"><spring:message
        ...
        <div class="modal-content">
            <form id="deleteForm" action="#" method="POST">
                ...
                <div class="modal-body">
                    <p>
                        <spring:message
                            code="label.manageTuitionPaymentPlanGroup.searchTuitionPaymentPlanGroup.confirmDelete" />
                    </p>
                </div>
