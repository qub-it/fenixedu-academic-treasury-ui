...
<div class="page-header">
	<h1><spring:message code="label.manageTuitionPaymentPlanGroup.readTuitionPaymentPlanGroup" />
		<small></small>
	</h1>
</div>
<div class="modal fade" id="deleteModal">
  <div class="modal-dialog">
    ...
    <form id ="deleteForm" action="${pageContext.request.contextPath}/academictreasury/managetuitionpaymentplangroup/tuitionpaymentplangroup/delete/${tuitionPaymentPlanGroup.externalId}"   method="POST">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><spring:message code="label.confirmation"/></h4>
      </div>
      <div class="modal-body">
        <p><spring:message code = "label.manageTuitionPaymentPlanGroup.readTuitionPaymentPlanGroup.confirmDelete"/></p>
      </div>
...
<div class="well well-sm" style="display:inline-block">
	<span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/academictreasury/managetuitionpaymentplangroup/tuitionpaymentplangroup/"  ><spring:message code="label.event.back" /></a>
|&nbsp;&nbsp;	<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp;<a class="" href="${pageContext.request.contextPath}/academictreasury/managetuitionpaymentplangroup/tuitionpaymentplangroup/update/${tuitionPaymentPlanGroup.externalId}"  ><spring:message code="label.event.update" /></a>
|&nbsp;&nbsp;</div>
...
<table class="table">
		<tbody>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.TuitionPaymentPlanGroup.code"/></th> 
	<td>
		<c:out value='${tuitionPaymentPlanGroup.code}'/>
	</td> 
</tr>
<tr>
	<th scope="row" class="col-xs-3"><spring:message code="label.TuitionPaymentPlanGroup.name"/></th> 
	<td>
