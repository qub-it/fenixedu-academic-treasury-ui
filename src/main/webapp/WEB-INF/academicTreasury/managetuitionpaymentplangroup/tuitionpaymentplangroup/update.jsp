...
<div class="page-header">
    <h1>
        <spring:message
            code="label.manageTuitionPaymentPlanGroup.updateTuitionPaymentPlanGroup" />
        <small></small>
    </h1>
</div>
...
<div class="well well-sm" style="display: inline-block">
    <span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>&nbsp;<a
        class=""
        href="${pageContext.request.contextPath}/academictreasury/managetuitionpaymentplangroup/tuitionpaymentplangroup/read/${tuitionPaymentPlanGroup.externalId}"><spring:message
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input id="tuitionPaymentPlanGroup_name"
                        ...
                        value='${not empty param.name ? param.name : tuitionPaymentPlanGroup.name.json() } ' />
                </div>
            </div>
