<%@page
    import="org.fenixedu.academictreasury.ui.academictaxdebtcreation.AcademicTaxDebtCreationBeanController"%>
...
<form name='form' method="post" class="form-horizontal"
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <ui-select
                        ...
                        name="registration"
                        ng-model="$parent.object.academicTax"
            ...
            <div class="form-group row"
                ng-show="object.improvementTaxSelected || object.improvementTaxSelected === 'true'">
                <div class="col-sm-2 control-label">
                    <spring:message
                ...
                <div class="col-sm-6">
                    <ui-select
                        ...
                        ng-model="$parent.object.improvementEvaluation"
                        theme="bootstrap" ng-disabled="disabled"
                        on-select="onBeanChange($model)"> <ui-select-match>{{$select.selected.text}}</ui-select-match>
                    <ui-select-choices
                    ...
                    <span
                        ng-bind-html="enrolmentEvaluations.text | highlight: $select.search"></span>
                    </ui-select-choices> </ui-select>
                </div>
            </div>
